<nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
     ...
     <li class="nav-item">
          ...
          <li class="nav-item">
               <a class="nav-link" href="<?php echo FRONT_ROOT ?>Category/showAddCategory">Añadir tipo de evento </a>
          </li>
          <li class="nav-item">
               <a class="nav-link" href="<?php echo FRONT_ROOT ?>Artist">Listar Artistas</a>
          </li>
          <li class="nav-item">
